  ...
  return (
    <div className={`${s.privacyPolice} p-5`}>
      ...
      <p className="p-2">
        ...
        информации, которую сайт Бибинто (далее – Бибинто), расположенный на
        доменном имени <a href="http://bibinto.com">bibinto.com</a> (а также его
        субдоменах), может получить о Пользователе во время использования сайта{" "}
        <a href="http://bibinto.com">bibinto.com</a> (а также его субдоменов),
      ...
      <p className="p-2">
        ...
        сотрудники на управление сайтом Бибинто, которые организуют и (или)
      ...
      <p className="p-2">
        1.1.5. «Сайт Бибинто» - это совокупность связанных между собой
        веб-страниц, размещенных в сети Интернет по уникальному адресу (URL):{" "}
        <a href="http://bibinto.com">bibinto.com</a>, а также его субдоменах.
      </p>
      <p className="p-2">
        1.1.6. «Субдомены» - это страницы или совокупность страниц,
        расположенные на доменах третьего уровня, принадлежащие сайту Бибинто, а
        также другие временные страницы, внизу которых указана контактная
        информация Администрации.
      </p>
      <p className="p-2">
        1.1.5. «Пользователь сайта Бибинто» (далее Пользователь) – лицо, имеющее
        доступ к сайту Бибинто, посредством сети Интернет и использующее
        информацию, материалы и продукты сайта Бибинто.
      </p>
      <p className="p-2">
      ...
      <p className="p-2">
        ...
        через который Пользователь получает доступ на Бибинто.
      </p>
      <h1 className="fw-bold fs-5 mt-2">2. Общие положения</h1>
      <p className="p-2">
        2.1. Использование сайта Бибинто Пользователем означает согласие с
      ...
      <p className="p-2">
        ...
        Пользователь должен прекратить использование сайта Бибинто.
      </p>
      <p className="p-2">
        2.3. Настоящая Политика конфиденциальности применяется к сайту Бибинто.
        Бибинто не контролирует и не несет ответственность за сайты третьих лиц,
      ...
      <h1 className="fw-bold fs-5 mt-2">
      ...
      <p className="p-2">
        ...
        предоставляет по запросу Администрации при регистрации на сайте Бибинто
      ...
      <p className="p-2">
        ...
        заполнения форм на сайте Бибинто и включают в себя следующую информацию:
      </p>
      ...
      <p className="p-2">
        3.3. Бибинто защищает Данные, которые автоматически передаются при
        посещении страниц: - IP адрес;
      </p>
      ...
      <p className="p-2">
        3.3.2. Бибинто осуществляет сбор статистики об IP-адресах своих
      ...
      <p className="p-2">
        4.1.1. Идентификации Пользователя, зарегистрированного на сайте Бибинто
      ...
      <p className="p-2">
        ...
        уведомлений, запросов, касающихся использования сайта Бибинто, обработки
      ...
      <p className="p-2">
        4.1.6. Создания учетной записи для использования частей сайта Бибинто,
      ...
      <p className="p-2">
        ...
        возникновении проблем, связанных с использованием сайта Бибинто.
      </p>
      <p className="p-2">
        4.1.9. Предоставления Пользователю с его согласия специальных
        предложений, новостной рассылки и иных сведений от имени сайта Бибинто.
      </p>
      <h1 className="fw-bold fs-5 mt-2">
      ...
      <p className="p-2">
        ...
        данных, необходимых для использования сайта Бибинто, и давать согласие
        на их обработку.
      </p>
      <p className="p-2">
      ...
      <p className="p-2">
        ...
        Администрацией Ресурса. 7.2.3. Была разглашена с согласия Пользователя.
      </p>
      <p className="p-2">
      ...
      <p className="p-2">
        ...
        которой он может иметь доступ как к части сайта Бибинто, несет лицо,
        предоставившее такую информацию.
      </p>
      <p className="p-2">
        7.5. Пользователь соглашается, что информация, предоставленная ему как
        часть сайта Бибинто, может являться объектом интеллектуальной
        ...
        информацию на сайте Бибинто. Пользователь не вправе вносить изменения,
      ...
      <p className="p-2">
        ...
        свободном публичном доступе на сайте Бибинто) допускается их
        распространение при условии, что будет дана ссылка на Бибинто.
      </p>
      <p className="p-2">
        ...
        коммуникационных данных, содержащихся на сайте Бибинто или передаваемых
        через него.
      </p>
      <p className="p-2">
      ...
      <p className="p-2">
        ...
        размещенную пользователем на сайте Бибинто, включая, но не
      ...
      <p className="p-2">
        ...
        размещения на сайте Бибинто, если иное не предусмотрено новой редакцией
        Политики конфиденциальности.
      </p>
      <p className="p-2">
        9.3. Все предложения или вопросы касательно настоящей Политики
        конфиденциальности следует сообщать по адресу: admin@bibinto.com
      </p>
      <p className="p-2">
        9.4 Действующая Политика конфиденциальности размещена на странице по
        адресу http://bibinto.com
      </p>
    </div>
  )
}
