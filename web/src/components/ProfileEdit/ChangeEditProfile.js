...
export default function ChangeEditProfile() {
    ...
    const [getUrl, {data: uploadData}] = useLazyQuery(URL_UPLOAD_QUERY, {onCompleted: loadAvatar});
                ...
                <div className="row">
                    ...
                    <div className="d-flex mb-2">
                        ...
                        <div className="col-10 ps-4">
                            <input type="text" value={meData?.me?.firstName} onChange={(e) => e.target.value } className="border border-1 pt-1 pb-1 ps-2 w-50" />
                    ...
                    <div className="d-flex mb-2">
                        ...
                        <div className="col-10 ps-4">
                            <input type="text" value={meData?.me?.username} onChange={(e) => e.target.value }  className="border border-1 pt-1 pb-1 ps-2 w-50" />
                            <div className="mt-2">
